...
read -p "What directory would you like to backup? : " directory
...
for f in $directory
do
	cp -u $directory/* $HOME/BACKUP_FILES
done
...
print_info () {
ls -al $HOME/BACKUP_FILES; $du -sh $HOME/BACKUP_FILES
}

print_info BACKUP_FILES
